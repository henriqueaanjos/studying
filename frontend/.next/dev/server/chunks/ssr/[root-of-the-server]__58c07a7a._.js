...
(()=>{
    const e = new Error("Cannot find module './classes'");
...
const contents = [
    {
        ...
        contentNumber: 0,
        type: 'pdf',
        class: classes.filter((c)=>c.discipline.id === 1 && c.classNumber === 0)[0],
        duration: 3600
    },
    {
        id: 2,
        contentNumber: 1,
        type: 'video',
        class: classes.filter((c)=>c.discipline.id === 1 && c.classNumber === 1)[0],
        duration: 973
    }
];
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__58c07a7a._.js.map