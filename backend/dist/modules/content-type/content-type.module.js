...
exports.ContentTypeModule = ContentTypeModule = __decorate([
    (0, common_1.Module)({
        controllers: [content_type_controller_1.ContentTypeController],
        providers: [content_type_service_1.ContentTypeService, PrismaService_1.PrismaService],
        exports: [content_type_service_1.ContentTypeService],
    })
], ContentTypeModule);
